...
<body>
  ...
  <form class="container" id="form_1">
    ...
    <div class="row form-inline">
      <label class="offset-3" >
        <input type="radio" name="agreeyes" value="yes">          //
        どうい(Đồng ý)
      </label>
      <label class="offset-1"  >
        <input type="radio" name="agreeno" value="no">            //
        どういしない(Không đồng ý)
      </label>
    </div>
    <div  id="form_2">
      ...
      <div class="row ">
        ...
        <label  >
          <input type="radio" name="sexboy" value="male">
          おとこ 
        </label>
        <label class="offset-1"  >
          <input type="radio" name="sexgirl" value="female">
          おんな
        </label>
      </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9 col-sm-12" style="background-color:#F5F5F5; padding:3%">
          <label class="col-md-9 col-sm-12"  for="degree">
            <input type="radio" name="degreeuni" value="university">
            だいがく/University
          </label>
          <label class="col-md-9 col-sm-12" for="degree">
            <input type="radio" name="degreehight" value="hightSchool">
            こうこう/High School
          </label>
          <label class="col-md-9 col-sm-12" for="degree">
            <input type="radio" name="degreevoca" value="vocational">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9 col-sm-12" style="background-color:#F5F5F5; padding:3%">
          <label style="margin-right:2%"  for="degreeJapan">
            <input type="radio" name="degreeJapan1" value="n1">
            N1
          </label>
          <label style="margin-right:2%" for="degreeJapan">
            <input type="radio" name="degreeJapan2" value="n2">
            N2
          </label>
          <label  style="margin-right:2%" for="degreeJapan">
            <input type="radio" name="degreeJapan3" value="n3">
            N3
          </label>
          <label  style="margin-right:2%"  for="degreeJapan">
            <input type="radio" name="degreeJapan4" value="n4">
            N4
          </label>
          <label style="margin-right:2%" for="degreeJapan">
            <input type="radio" name="degreeJapan5" value="n5">
            N5
          </label>
        </div>
    </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-md-9 col-sm-12" style="background-color:#F5F5F5; padding:3%">
          <label class="col-md-9 col-sm-12"  for="Gakko">
            <input type="radio" name="Gakko1" >
            ① Gozen / AM
          </label>
          <label class="col-md-9 col-sm-12" for="Gakko">
            <input type="radio" name="Gakko2" >
            ② Đi / Chiều
          </label>
          <label class="col-md-9 col-sm-12" for="Gakko">
            <input type="radio" name="Gakko3" >
            ③ Gosen-Yugata
          </label>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-9 col-sm-12" style="background-color:#F5F5F5; padding:3%">
          <label class="col-md-9 col-sm-12"  for="Gakko">
            <input type="radio" name="Gakko01" >
            ① あさ6じ～あさ9じ
          </label>
          <label class="col-md-9 col-sm-12" for="Gakko">
            <input type="radio" name="Gakko02" >
            ② あさ9じ～ひる12じ
          </label>
          <label class="col-md-9 col-sm-12" for="Gakko">
            <input type="radio" name="Gakko04" >
            ④　ひる3じ～ゆうがた6じ
          </label>
          <label class="col-md-9 col-sm-12" for="Gakko">
            <input type="radio" name="Gakko05" >
            ⑤　ゆうがた6じ～よる9じ
          </label>
          <label class="col-md-9 col-sm-12" for="Gakko">
            <input type="radio" name="Gakko06" >
            ⑥　よる9じ～よる12じ
          </label>
          <label class="col-md-9 col-sm-12" for="Gakko">
            <input type="radio" name="Gakko07" >
            ⑦　よる12じ～あさ6じ
          </label>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-9 col-sm-12" style="background-color:#F5F5F5; padding:3%">
          <label style="margin-right:2%"  for="timeWork">
            <input type="radio" name="timeWork1" >
            月
          </label>
          <label style="margin-right:2%" for="timeWork">
            <input type="radio" name="timeWork2" >
            火 
          </label>
          <label  style="margin-right:2%" for="timeWork">
            <input type="radio" name="timeWork3">
            水
          </label>
          <label  style="margin-right:2%"  for="timeWork">
            <input type="radio" name="timeWork4" >
            木 
          </label>
          <label style="margin-right:2%" for="timeWork">
            <input type="radio" name="timeWork5" >
            金
          </label>
          <label style="margin-right:2%" for="timeWork">
            <input type="radio" name="timeWork6" >
            土
          </label>
          <label style="margin-right:2%" for="timeWork">
            <input type="radio" name="timeWork7" >
            日    
          </label>
        </div>
    </div>
  ...
  <div class="d-flex justify-content-center "  id="btnNext">
    <button class="btn-primary mt-0 mb-4 p-2"  type="submit" name="sbNext"> Next</button>
  </div>
  <?php
     if(isset($_POST['sbNext'])){
